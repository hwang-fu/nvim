...
--                              in lua/jwa/lsp/servers/hls.lua).
...
--
-- Telescope extension is loaded in lua/jwa/telescope.lua via
...
-- in lua/jwa/lsp/init.lua. Calling helpers.define_server
...
return {
	...
	lazy = false,
	init = function()
		require("jwa.lsp.servers.hls").setup()
	end,
}
