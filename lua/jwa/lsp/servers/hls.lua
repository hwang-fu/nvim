...
-- `init` hook in lua/jwa/plugins/spec/haskell_tools.lua (NOT from lsp/init.lua's
...
--
-- And via the Telescope extension (loaded in lua/jwa/telescope.lua
    ...
    vim.g.haskell_tools = {
        ...
        hls = {
            ...
            on_attach = function(client, bufnr)
                ...
                -- lua/jwa/lsp/servers/rust_analyzer.lua.
                --
