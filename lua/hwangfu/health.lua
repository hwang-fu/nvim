-- ============================================================================
-- :checkhealth hwangfu - the fresh-machine report (2026-08-19).
--
...
--
-- Wired by Neovim's convention: this file being lua/hwangfu/health.lua
-- makes `:checkhealth hwangfu` call M.check(). No registration needed.
-- ============================================================================
...
function M.check()
    ...
    for _, f in ipairs(require("hwangfu.lsp.format").FORMATTER_BINARIES) do
    ...
    for _, name in ipairs(require("hwangfu.lsp").SERVERS) do
