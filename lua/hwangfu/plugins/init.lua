...
local plugins = {
	...
	-- be fancy, this file stays ASCII.
	{
	...
	-- Colorschemes (selected per-filetype by lua/hwangfu/colors.lua).
	--
	...
	--
	-- Note: nvim-lspconfig was previously listed here. It is no longer needed
	-- because we use the native vim.lsp.config() / vim.lsp.enable() API in
	-- lua/hwangfu/lsp/, and every server file supplies its own cmd, filetypes,
	-- and root_markers via helpers.define_server.
	--
