...
-- `init` hook in lua/jwn/plugins/spec/haskell_tools.lua (NOT from lsp/init.lua's
...
--
-- And via the Telescope extension (loaded in lua/jwn/telescope.lua
    ...
    vim.g.haskell_tools = {
        ...
        hls = {
            ...
            on_attach = function(client, bufnr)
                ...
                -- lua/jwn/lsp/servers/rust_analyzer.lua.
                --
