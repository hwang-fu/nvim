...
--
-- Configuration lives in lua/jwn/lsp/servers/rust_analyzer.lua
...
-- table in lua/jwn/lsp/init.lua. Calling helpers.define_server
...
return {
	...
	lazy = false,
	init = function()
		require("jwn.lsp.servers.rust_analyzer").setup()
	end,
}
