...
- **OCaml** (ocaml.nvim): `:OCaml*` commands expose the Merlin features standard LSP cannot reach; see [ocaml](ocaml.md). OCaml buffers also show inlay type hints and type-signature codelenses.
